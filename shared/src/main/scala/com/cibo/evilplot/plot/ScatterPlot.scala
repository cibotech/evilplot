...
object ScatterPlot {
  ...
  private case class ScatterPlotRenderer(pointRenderer: PointRenderer) extends PlotRenderer[Seq[Point]] {
  ...
  def apply(
    ...
    Plot[Seq[Point]](data, xbounds, ybounds, ScatterPlotRenderer(pointRenderer))
  }
}
